...
// export const schema = {
//     node: 'vector', // type name
//     icon: 'circle_dot', // icon name
//     stem:{
//         x: {node:'decimal', default:0}, // omit default to prevent auto-creation of stem node 
//         y: {node:'decimal', default:0}, // add type:'list' or type:'set' for ordered or non-ordered multiplicity  
//         z: {node:'decimal', default:0},
...
// // Computation triggered by stem changes:
// export function compute({app, id, stem, patch}){ 

//     // Object that will be available as stem.my_schema_name within other nodes
//     const inner = new Vector3( 
//         stem.x ?? 0, 
//         stem.y ?? 0, 
//         stem.z ?? 0,
...
//     // List of interactable objects for the host application, delimit.art
//     const outer = [
//         {object: 'point', // host-node name, NOT RELATED to compute-nodes like this one
//             x: inner.x, 
//             y: inner.y, 
//             z: inner.z,
//         },
